...
extern unsigned char sd_readdata(unsigned char *buf, unsigned int len);
extern unsigned char sd_writedata(unsigned char *buf, unsigned int len, unsigned char token);
extern unsigned long sd_response(void);
extern unsigned char sdc_readsector(unsigned char *buf, unsigned long lba);
extern unsigned char sdc_readsectors(unsigned char *buf, unsigned long lba, unsigned int count);
extern unsigned char sdc_writesector(unsigned char *buf, unsigned long lba);
extern unsigned char sdc_writesectors(unsigned char *buf, unsigned long lba, unsigned int count);
